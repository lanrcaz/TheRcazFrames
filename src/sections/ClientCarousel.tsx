...
const CLIENTS: ClientSlideData[] = [
  {
    ...
    description: 'A premium automotive commercial for Lucid Motors filmed across Abu Dhabi. Architectural cityscapes meet meticulous car cinematography.',
    metadata: 'DIRECTOR \u00B7 DP \u00B7 AUTOMOTIVE',
  ...
  },
  {
    ...
    description: 'A Red Bull branded documentary on competitive breakdancing. Raw, kinetic energy captured through dynamic movement and intimate portraits.',
    metadata: 'DIRECTOR \u00B7 EDITOR \u00B7 SPORT',
  ...
  },
  {
    ...
    description: 'A high-octane commercial campaign for the theatrical release of Bad Boys II. Explosive action and the electric energy of Will Smith and Martin Lawrence.',
    metadata: 'DIRECTOR \u00B7 ACTION \u00B7 CINEMA',
  ...
  },
  {
    ...
    description: 'A branded documentary exploring the legacy and evolution of the Volkswagen Golf GTI. From the original Mk1 to the latest generation.',
    metadata: 'DIRECTOR \u00B7 DOCUMENTARY \u00B7 AUTOMOTIVE',
